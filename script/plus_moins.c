...
void deux_joueurs(int choix_joueur, int valeur_a_trouver, int quel_joueur, int nombre_de_coup, int nombre_de_essaie_1, int nombre_de_essaie_2, int points_joueur_1, int points_joueur_2, int nombre_de_tour)
{
    int total_points_1;
    int total_points_2;
    total_points_1 = 0;
    ...
    if (quel_joueur == 1)
    {
        for (int x = 1; x <= nombre_de_tour; x++)
        {
            ...
            printf("Le nombre de points pour joueur 2 est %d au tour %d\n", points_joueur_2, x);
            total_points_2 = total_points_2 + points_joueur_2;
            ...
            printf("Le nombre de points pour joueur 1 est %d au tour %d\n", points_joueur_1, x);
            total_points_1 = total_points_1 + points_joueur_1;
            srand (time(NULL));
            valeur_a_trouver = rand() % 100 + 1;
    ...
    printf("Le total des points du joueur 1 est %d\n", total_points_1);
    printf("Le total des points du joueur 2 est %d\n", total_points_2);
    if (total_points_1 > total_points_2)
    {
        printf("Le joueur 1 est le gagnant\n");
    }
    else if (total_points_1 < total_points_2)
    {
...
int main()
{
    ...
    else if (mode_de_jeu == 2)
    {
        ...
        essaie_1 = 0;
        essaie_2 = 0;
        deux_joueurs(choix, valeur, joueur, coup, essaie_1, essaie_2, points_1, points_2, tour);; 
    }
    return 0;
}
